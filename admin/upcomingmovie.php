        ...
        <div class="content" id="content">
            ...
            <div class="maincontent">
              ...
              <?php 
                ...
                $sql="select * from upcomingmovies ORDER BY id DESC";
                  ...
                  <div class="col-md-11" id="users">
                    <div class="panel panel-primary"  style="margin: 20px 20px;">
                      ...
                      <div class="panel-body">
                        ...
                        <a href="addupcomingmovie.php" class="new" style="float: right; margin-right: 10px;">
                        ...
                        <table class="table table-bordered">
                          ...
                          <tbody>
                            ...
                            <tr class="data<?php echo $data['id']; ?>">
                              ...
                              <td><?php echo $i++ ?></td>
                              <td class="mname<?php echo $data['id']; ?>" > <?php echo $data['movie_name']; ?></td>
                              <td class="mdirector<?php echo $data['id']; ?>"><?php echo $data['director']; ?></td>
                              <td class="mgenres<?php echo $data['id']; ?>"><?php echo $data['genres']; ?></td>
                              <td class="mdate<?php echo $data['id']; ?>"><?php echo $data['relaseDate']; ?></td>
                              <td><a href="addmovielist.php?id=<?php echo $data['id'];  ?>" class="view">Add Movie List</a></td>                  
                              <td>
                                ...
                                <a href="" data-toggle="modal" data-target="#edit" class="btn btn-primary" style="border-radius: 0;" data-id="<?php echo $data['id']; ?>" data-name="<?php echo $data['movie_name']; ?>" data-genres="<?php echo $data['genres']; ?>" data-date="<?php echo $data['relaseDate']; ?>" ><span class="glyphicon glyphicon-pencil"> </span></a>
                        ...
                        <script type="text/javascript">
                          ...
                          $(document).on('click', '#submits', function(e) {
                            ...
                            $.ajax({
                              ...
                              url: 'ajaxedit.php',
                              data: {
                                'upcomingmovieeditid': id,'name':name,'genres':genres,'date':date
                              },
                              success: function(data) {
