                  ...
                  <div class="col-md-11" id="users">
                    <div class="panel panel-primary"  style="margin: 20px 20px;">
                      ...
                      <div class="panel-body">
                        ...
                        <input type="text"  id="search" style="margin: 3px 10px; padding: 5px 5px;" name=""  placeholder="Search Movie..">
                        ...
                        <table class="table table-bordered">
                          ...
                          <tbody>
                            ...
                            <tr class="data<?php echo $data['id']; ?>">
                              ...
                              <td class="mimdb<?php echo $data['id']; ?>"><?php echo $data['imdbRating']; ?></td>
                        ...
                        <script type="text/javascript">
                          ...
                          $(document).on('click', '#submits', function(e) {
                            ...
                            $.ajax({
                              ...
                              url: '/admin/editMovie',
                              data: {
                                'id': id,'name':name,'genres':genres,'imdb':imdb,'date':date
                              },
                              success: function(data) {
